...
public class IncidentService {	
	...
	public Response createRecord(RequestSpecification requestSpecification, File requestPayload) {
		return given()
	...
	public Response updateExistingRecord(RequestSpecification requestSpecification, String sysId, File requestPayload) {
		return given()
		.spec(requestSpecification)	
		.contentType(ContentType.JSON)
		.log().all()
